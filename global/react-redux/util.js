...
export default  (config)=>{
    ...
    let finalReducer = typeof reducers=='function'?reducers:combineReducers(reducers);

    let store = applyMiddleware.apply(null,middleWareArr)(createStore)(finalReducer);
